...
const WorkSection = () => {
  return (
    <section className="mx-[90px] mb-28 rounded-3xl shadow border border-gray-200">
        ...
        <div className="px-[40px] pt-[123px] pb-8 flex justify-center gap-4">
            <div className="text-center">
                <h1 className="custom-text relative  p-4  text-9xl text-satoshi-black font-bold leading-10">1</h1>
                <h2 className=" text-gray-800 text-satoshi-black font-bold text-4xl ">Subscribe</h2>
                <p className="bg-transparent">Subscribe to a plan & you’ll get an instant access to your private Slack channel.</p>
            </div>
            ...
            <div className="text-center">
                  <h1 className=" relative top-8 z-[-99] text-purple-300  text-9xl text-satoshi-black font-bold leading-10">2</h1>
                <h2 className="text-gray-800 text-satoshi-black font-bold text-4xl">Subscribe</h2>
                <p>Subscribe to a plan & you’ll get an instant access to your private Slack channel.</p>
            </div>   
            ...
            <div className="text-center">
                  <h1 className="relative top-8 z-[-99] text-purple-300 text-9xl text-satoshi-black font-bold leading-10">3</h1>
                <h2 className="text-gray-800 text-satoshi-black font-bold text-4xl">Subscribe</h2>
                <p>Subscribe to a plan & you’ll get an instant access to your private Slack channel.</p>
            </div>        
        </div>
