...
const Hero = () => {
  return (
    <section className="py-11 px-44 flex flex-col mt-16 items-center justify-center">
        ...
        <p className="my-4 text-gray-600 text-center font-satoshi text-xl font-bold leading-loose">From strategic planning to digital presence, we're your dedicated partner in achieving solo success.</p>
