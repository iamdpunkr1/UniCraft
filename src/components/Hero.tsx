...
const Hero = () => {
  return (
    <section className="py-11 px-44 flex flex-col mt-16 items-center justify-center">
        <h1 className="text-gray-800 text-7xl font-satoshi-bold font-black text-center leading-118 tracking-tight">
         Elevate Your Presence with Seamless Design and Innovation.
        </h1>
        <p className="my-2 text-gray-600 text-center font-satoshi text-xl font-bold leading-loose">From strategic planning to digital presence, we're your dedicated partner in achieving solo success.</p>
        <button className="shadow-inner justify-center items-center gap-2.5 inline-flex rounded-lg bg-gray-800 text-gray-50 text-xl font-bold px-8 py-4 h-14 w-52">View Pricing</button>
